...
**Update 2020-04-21**: AWS has released a [new HTTP API Gateway](https://aws.amazon.com/blogs/compute/building-better-apis-http-apis-now-generally-available/), which was specifically designed to make straight forward proxy integration fast and easy. This blog post on the other hand is about the REST API Gateway (which is still arround and also has improved over the years). 
